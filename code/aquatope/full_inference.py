...
def load_trained_model(model_artifacts_dir: str, device: str, hashfunc: str):
    predict_loc = os.path.join(model_artifacts_dir, "predict_{}.pt".format(hashfunc))
...
def inference(x: list, external: list, model, device, batch_size: int = 1): 
